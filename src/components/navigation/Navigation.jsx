...
const Navigation = () => {
  ...
  return (
    <div
      className={`${
        scrolling ? "drop-shadow-2xl bg-[#03051b86] p-0 ease-soft-spring duration-400 transition-all lg:px-0 lg:mt-0" : "drop-shadow-none px-2 lg:px-[2%] ease-soft-spring duration-400 transition-all lg:mt-[20px]"
